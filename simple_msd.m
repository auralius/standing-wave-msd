...
N = 20; % Number of masses (rigid bodies)
M = 0.01; % The mass of each rigid body
ks = 1e3; % The spring coefficient, generally very stiff, meaning it is not very stretchable
...
% Time vector
ts = 1e-3;
tsim = 5; %  How long the simulation should run
timespan = 0:ts:tsim;
